 ...
 */
class Config_Lib_NotORM 
   extends Config_Lib_NotORM_Abstract
{
    ...
    function __construct(PDO $connection, NotORM_Structure $structure = null, NotORM_Cache $cache = null)
    {
        ...
        if (!isset($structure)) {
            $structure = new Config_Lib_NotORM_Structure_Convention;
        }
    ...
    {
        return new Config_Lib_NotORM_Result($this->structure->getReferencingTable($table, ''), $this, true);
    }
    ...
    {
        $return = new Config_Lib_NotORM_Result($this->structure->getReferencingTable($table, ''), $this);
        if ($where) {
